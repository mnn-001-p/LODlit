...
def get_lit_related_matches_bow(lang:str) -> dict:
    ...
    the info about which QID is a related match to the query term is taken from /related_matches/rm.csv
    lang: str, 'en' or 'nl'
    ...
    # load wd bows
    path_to_bows = f"/Wikidata/gzip_wd_bows_{lang}.json"
...
def get_cs(lang:str):
    ...
    # load wd bows
    path_wd_bows = f"/Wikidata/gzip_wd_bows_{lang}.json"
...
def get_n_hits_by_properties(path_to_results:str, lang:str, group_by_lemma=False):
    ...
    # loading query terms
    path_query_terms = "/query_terms.json"
