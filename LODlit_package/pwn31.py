...
def get_lit_related_matches_bow() -> dict:
    ...
    the info about which PWN synset is a related match to the query term is taken from /related_matches/rm.csv
    ...
    # load pwn bows
    path_to_bows = f"/PWN/pwn31_bows.json"
...
def get_cs():
    ...
    # load all pwn bows
    path_pwn_bows = f"/PWN/pwn31_bows.json"
