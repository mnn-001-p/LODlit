...
# Download Open Dutch WordNet from "/OpenDutchWordnet"
...
def _set_odwn(path_odwn:str):
    ...
    Download OpenDutchWordnet from "/OpenDutchWordnet"
...
def get_le_info(le_ids:list, path_odwn:str) -> dict:
    ...
    # load all glosses
    path_to_glosses = "/ODWN/odwn_synset_glosses.json"
...
def _shape_search_results(instance,query_term:str,le,all_synset_definitions:dict,found_in:str,example="") -> dict:
    ...
    query_term: str
    le: class le.Le
    all_synset_definitions: dict, parses "/ODWN/odwn_synset_glosses.json" 
    found_in: str
...
def get_lit_related_matches_bow() -> dict:
    ...
    # load odwn bows
    path_to_bows = f"/ODWN/odwn_bows.json"
...
def get_cs():
    ...
    # load all pwn bows
    path_odwn_bows = f"/ODWN/odwn_bows.json"
